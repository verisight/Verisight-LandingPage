      ...
      <div className="flex-grow flex justify-center items-center">
        <div className="max-w-4xl w-full px-6">
          <div className="mt-20 text-black py-10 space-y-6">
            ...
            <h1 className="text-xl font-bold h1">Privacy Policy</h1>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <p>
                  <strong>Application</strong> refers to Verisight, the software
              ...
              <li>
                <p>
                  ...
                  in this Agreement) refers to Verisight Labs.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Verisight Labs, accessible from{" "}
                  <a
                    href="https://verisightlabs.com/"
                    rel="external nofollow noopener"
                    target="_blank"
                  >
                    https://verisightlabs.com/
                  </a>
                </p>
              </li>
              <li>
            ...
            <ul>
              <li>
                <p>
                  By email:{" "}
                  <a href="mailto:support@verisightlabs.com">
                    support@verisightlabs.com
                  </a>
                </p>
              </li>
              <li>
